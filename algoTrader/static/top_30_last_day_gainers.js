...
document.getElementById("top_30_last_day_gainers").addEventListener("click", async function() {
    cleanupAll();
        try {
            const gainers_url="/top_30_last_day_gainers/"
            ...
            const container = document.getElementById("form-container");
                ...
                <div class="top_30_gainers_container">
                    <h1>Top 30 Last Day Gainer Companies</h1>
